<template>
    <div class="metadata-type">
      <div class="metadata-type-select">
        ...
        <DataTableEnum v-else-if="type === 'enum'"   v-model:value="data" placement="bottomRight" @confirm="valueChange"/>
        ...
        <DataTableInteger
            ...
            @confirm="valueChange"
        />
        <DataTableFile v-else-if="type === 'file'"  v-model:value="data.fileType"  placement="bottomRight" @confirm="valueChange"/>
...
<script lang="ts" name="OutPutParams" setup>
