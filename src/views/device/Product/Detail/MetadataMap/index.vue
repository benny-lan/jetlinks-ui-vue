    ...
    <div class="metadata-map">
        <div class="left">
          <j-space style="margin-bottom: 24px">
                <j-select allow-clear placeholder="请选择属性名称" show-search style="width: 250px;" @change="onSearchChange">
                    <j-select-option v-for="item in dataSourceCache" :key="item?.id" :label="item.name" :value="item?.id">{{item?.name}}</j-select-option>
                </j-select>
...
<script lang='ts' name='MetadataMap' setup>
