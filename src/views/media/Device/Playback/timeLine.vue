...
<template>
    <div class="time-line-warp">
        ...
        <div class="time-line-content" ref="LineContent">
            ...
            <div v-show="timePosition" id="btn" :style="{left: timePosition + 'px' }" class="time-line-btn"></div>
            <div v-show="timePosition" id="time" :style="{left: (timePosition - 15) + 'px' }" class="time-line">
