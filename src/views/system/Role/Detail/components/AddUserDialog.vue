<template>
    <j-modal title="新增" visible width="1000px" @cancel="emits('update:visible', false)" @ok="confirm">
        <!-- <j-advanced-search
            :columns="columns"
            type="simple"
        ...
        <j-pro-table ref="tableRef" :columns="columns" :params="queryParams" :request="getUserList" :rowSelection="{
