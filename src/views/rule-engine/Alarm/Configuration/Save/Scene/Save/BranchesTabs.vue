        ...
        >
          <div v-for="(branch, index) in group.children">
            <div style="display: flex;align-items: center" v-if="show && branch.when.length">
              <span  style="padding-right: 12px;font-weight: bold;font-size: 16px;width: 46px; display: inline-block;">{{ index === 0 ? $t('Save.BranchesTabs.4265311-2') : $t('Save.BranchesTabs.4265311-3') }}</span>
